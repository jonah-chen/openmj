...
void ImGui::ImageRotated(ImTextureID user_texture_id, const ImVec2& size, int rot, const ImVec2& uv0, const ImVec2& uv1, const ImVec4& tint_col, const ImVec4& border_col)
{
...
bool ImGui::ImageButtonRotated(ImTextureID user_texture_id, const ImVec2& size, int rot, const ImVec2& uv0,  const ImVec2& uv1, int frame_padding, const ImVec4& bg_col, const ImVec4& tint_col)
{
    ImVec2 _uv0, _uv1, _uv2, _uv3;
    switch(rot % 360)
    {
