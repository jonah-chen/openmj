...
void t_ClosedHand(const char *hand, mj::Tile agari_pai, mj::U32f score,
                  mj::U64 yakus,
                  mj::U64 flags = mj::scoring::f_NormalPlay &
                                  mj::scoring::f_ClosedHandMask)
{
    mj::Hand h(hand);
    h.flags = flags;
    auto [calc_score, calc_yaku] = mj::scoring::score_hand(h, agari_pai);
    assert(calc_score == score,
           "Hand: " + (hand + (" score of " + std::to_string(score))) +
               " expected, got " + std::to_string(calc_score));
    assert(calc_yaku == yakus,
           "Hand: " + (hand + (" yaku of:\n" + mj::scoring::yaku_str(yakus))) +
...
int main()
{
    ...
    t_ClosedHand("w111222333444d22", mj::Tile("2d"), mj::scoring::k_Yakuman * 2,
                 mj::scoring::f_Daisushi | mj::scoring::f_Tsuuiisou |
                     mj::scoring::f_SuuAnkou | mj::scoring::f_DoubleYakuman);
    ...
    t_ClosedHand("m19p19s19w1234d1233", mj::Tile("3d"),
                 mj::scoring::k_Yakuman * 2,
    ...
    t_ClosedHand("m111999p11s111999", mj::Tile("1p"),
                 mj::scoring::k_Yakuman * 2,
                 mj::scoring::f_Chinroutou | mj::scoring::f_SuuAnkou |
                     mj::scoring::f_DoubleYakuman);
    ...
    t_ClosedHand("m222234p222s222d22", mj::Tile("2d"), mj::scoring::k_Mangan,
                 40 | mj::scoring::f_SanshokuSet | mj::scoring::f_Sanankou |
                     mj::scoring::f_MenTsumo);
    ...
    t_ClosedHand("m11223344557788", mj::Tile("1m"), mj::scoring::k_Baiman,
                 25 | mj::scoring::f_Chitoitsu | mj::scoring::f_ChinitsuC |
                     mj::scoring::f_MenTsumo);
    t_ClosedHand("m1199s1199w112233", mj::Tile("3w"), mj::scoring::k_Mangan,
                 25 | mj::scoring::f_Honroutou | mj::scoring::f_Chitoitsu |
                     mj::scoring::f_MenTsumo);
    t_ClosedHand("m1122334455d1122", mj::Tile("2d"), mj::scoring::k_Haneman,
                 25 | mj::scoring::f_Chitoitsu | mj::scoring::f_HonitsuC |
                     mj::scoring::f_MenTsumo);
    t_ClosedHand("m123p234d11122233", mj::Tile("2d"), mj::scoring::k_Mangan,
                 40 | mj::scoring::f_Shousangen | mj::scoring::f_Hatsu |
                     mj::scoring::f_Chun | mj::scoring::f_MenTsumo);
    t_ClosedHand("m123p123s11123999", mj::Tile("9s"), mj::scoring::k_Haneman,
                 40 | mj::scoring::f_JunchanC | mj::scoring::f_SanshokuSeqC |
                     mj::scoring::f_MenTsumo);
    t_ClosedHand("m123456789s33d222", mj::Tile("2d"), mj::scoring::k_Mangan,
                 40 | mj::scoring::f_IttsuC | mj::scoring::f_MenTsumo |
                     mj::scoring::f_Chun);
    ...
    t_ClosedHand("p22334488s334455", mj::Tile("2p"), mj::scoring::k_Haneman,
                 20 | mj::scoring::f_Pinfu | mj::scoring::f_Ryanpeikou |
                     mj::scoring::f_Tanyao | mj::scoring::f_MenTsumo);
    t_ClosedHand("p22334488s334455", mj::Tile("4s"), mj::scoring::k_Mangan,
                 30 | mj::scoring::f_Ryanpeikou | mj::scoring::f_Tanyao |
                     mj::scoring::f_MenTsumo);
    ...
    t_ClosedHand("p22334488d222333", mj::Tile("8d"), mj::scoring::k_Haneman,
                 40 | mj::scoring::f_HonitsuC | mj::scoring::f_Ipeikou |
                     mj::scoring::f_Chun | mj::scoring::f_Haku |
                     mj::scoring::f_MenTsumo);
    t_ClosedHand("s11223355778899", mj::Tile("9s"), mj::scoring::k_Sanbaiman,
                 20 | mj::scoring::f_Ryanpeikou | mj::scoring::f_ChinitsuC |
                     mj::scoring::f_Pinfu | mj::scoring::f_MenTsumo);
